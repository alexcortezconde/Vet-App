    ...
    <div className="space-y-8 pb-10 animate-in fade-in duration-700">
      ...
      <div className="relative group px-1">
        ...
        <input 
          ...
          className="w-full pl-14 pr-6 py-4 bg-white rounded-4xl border border-white shadow-md focus:outline-none focus:shadow-xl transition-all text-sm font-bold text-secondary"
        />
      </div>
      ...
      <div className="flex gap-5 overflow-x-auto pb-4 -mx-5 px-5 no-scrollbar">
        <div className="flex flex-col items-center gap-2 flex-shrink-0 cursor-pointer">
          ...
          <span className="text-[10px] font-black text-secondary uppercase tracking-widest">Crear</span>
        </div>
      ...
      <div className="space-y-10">
        {mockPosts.map(post => (
          <div key={post.id} className="bg-white rounded-5xl overflow-hidden shadow-xl shadow-secondary/5 border border-white group">
            <div className="px-6 py-5 flex items-center justify-between">
              ...
              <button className="text-slate-300 hover:text-secondary transition-colors"><MoreHorizontal className="w-6 h-6" /></button>
            </div>
            <div className="px-3">
            ...
            <div className="p-6">
              <div className="flex items-center gap-8 mb-4">
                ...
                <button className="ml-auto text-secondary/30 hover:text-secondary transition-colors"><Share2 className="w-6 h-6" /></button>
              </div>
